declare module 'lottie-react' {
  ...
  type LottieOptions<T extends RendererType = 'svg'> = Omit<
  ...
  type PartialLottieComponentProps = Omit<
  ...
  declare const useLottie: <T extends RendererType = 'svg'>(
  ...
  declare const useLottieInteractivity: ({
    actions,
    mode,
    lottieObj,
